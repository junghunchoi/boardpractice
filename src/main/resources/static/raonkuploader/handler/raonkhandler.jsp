...
<%
	...
	*/
    ...
    strRootFolder = request.getSession()
                           .getServletContext()
    ...
    upload.settingVo.setTempPath(
            strRootFolder + strPathChar + "raonkuploaddata" + strPathChar + "raonktemp");
    ...
    String[] arrAllowDownloadDirectoryPath = {strRootFolder + strPathChar + "raonkuploaddata",
