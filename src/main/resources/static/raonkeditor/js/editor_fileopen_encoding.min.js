...
function checkFileReaderSyncSupport(){if(fileOpenWorker=makeWorker("url",KEditorLayerWin._k_editor._config.fileEncodingWorkerJSUrl+"?t="+KEDITORTOP.RAONKEDITOR.UrlStamp))fileOpenWorker.onmessage=function(c){FileReaderSyncSupport=c.data.result;releaseWorker()},fileOpenWorker.postMessage({init:!0})}
function processFiles(c,f){if(FileReaderSyncSupport){var a=makeWorker("url",KEditorLayerWin._k_editor._config.fileEncodingWorkerJSUrl+"?t="+KEDITORTOP.RAONKEDITOR.UrlStamp);a&&(a.onmessage=function(a){f(a.data.hasBom,a.data.result)},Array.prototype.forEach.call(c,function(b){a.postMessage(b)}))}}
